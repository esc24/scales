"""
HX711 module for use with Raspberry Pi. 

This module provides a class that make using load cells hooked up to
an HX711 ADC chip straightforward.

Based heavily on tatobari and underdoeg python implementations.
...
class HX711:
    ...
    def set_gain(self, gain):
        if gain is 128:
            ...
            msg = 'Expected gain value of 128, 64 or 32, got {!r}'
            raise ValueError(msg.format(gain))
    ...
    def set_reading_format(self, byte_format="LSB", bit_format="MSB"):
        if byte_format == "LSB":
            ...
            msg = "Expected byte format of 'MSB' or 'LSB', got {!r}"
            raise ValueError(msg.format(byte_format))
        ...
        if bit_format == "LSB":
            ...
            msg = "Expected bit format of 'MSB' or 'LSB', got {!r}"
            raise ValueError(msg.format(byte_format))
    ...
    # I've found it is good practice to reset the hx711 if it wasn't
